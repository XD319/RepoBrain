...
import { evaluateExtractWorthiness, renderExtractSuggestionJson, renderExtractSuggestionMarkdown } from "../extract-suggestion.js";
import { buildSkillShortlist, renderSkillShortlist, renderSkillShortlistJson, resolveSuggestedSkillPaths } from "../suggest-skills.js";
...
import { applyRoutingFeedback, explainRoutingFeedbackForSkill, parseRoutingFeedbackStdin, renderExplainRoutingFeedbackText } from "../routing-feedback.js";
...
program
  ...
  .action(async (options: { task?: string; path: string[]; json?: boolean; format?: string; noSession?: boolean }) => {
